package com.jaime.jbpm.usertasks.assignment.loadcalculator;
...
public class CustomTaskCountLoadCalculator extends AbstractLoadCalculator {

	private static final String IDENTIFIER = "CustomTaskCountLoadCalculator";
	...
	public CustomTaskCountLoadCalculator() {
		super(IDENTIFIER);
	}
